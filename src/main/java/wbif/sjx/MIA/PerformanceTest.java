...
public class PerformanceTest {
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        ...
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/BigFilled.tif").getPath(), "UTF-8"));
        // getDistributionResults(
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/Blobs1.tif").getPath(), "UTF-8"));
        // getDistributionResults(
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/Blobs2.tif").getPath(), "UTF-8"));
        // getDistributionResults(
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/Blobs3.tif").getPath(), "UTF-8"));
        // getDistributionResults(
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/Spot1.tif").getPath(), "UTF-8"));
        // getDistributionResults(
        //         URLDecoder.decode(PerformanceTest.class.getResource("/performance/Squares.tif").getPath(), "UTF-8"));
    ...
    public static long evaluateObjectMemory(Obj obj, boolean verbosePerformance) {
        ...
        if (verbosePerformance)
            System.out.println("    Memory usage = " + (((double) bytes / 1048576d)) + " MB");
    ...
    public static void evaluateRandomAccessTime(Obj obj) {
        ...
        long startTime = System.nanoTime();
        for (Point<Integer> point : testPoints)
            obj.contains(point);
        long endTime = System.nanoTime();
    ...
    public static void reportDistribution(Obj obj) {
        ...
        System.out.print(dppXY + "," + dppZ + "," + nPoints + "," + xStdev + "," + xMin + "," + xMax + "," + yStdev
                + "," + yMin + "," + yMax + "," + zStdev + "," + zMin + "," + zMax);
